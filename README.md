...
- 实时识别正常活动、高风险失衡、跌倒、恢复起身和长时间卧倒
- 在服务侧输出事件流、时间线、会话摘要和历史会话记录
- 支持基于发布包的单视频推理、批量视频推理和运行时服务部署
- 支持基于历史会话的误报复查、区间标签回灌和定向再训练
...
- `值守总览`
面向照护人员，展示当前状态、风险变化、最近事件和当前会话摘要。

- `历史会话`
展示已归档会话、筛选条件和会话预览，支持查看 JSON 与 Markdown 记录。
