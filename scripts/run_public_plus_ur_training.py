...
DEFAULT_VAL_SUBJECTS = (
    ...
    "ur_fall:adl-39-cam0",
    "ur_fall:adl-40-cam0",
    "ur_fall:fall-29-cam0",
    "ur_fall:fall-30-cam0",
)
...
def main() -> None:
    ...
    parser.add_argument("--run-name", default="public_plus_ur")
    ...
    if train_interval_labels is not None and not train_interval_labels.is_absolute():
    ...
    raw_manifests = [
        ...
        manifest_dir / "ur_fall_valid.jsonl",
    ]
    pose_manifests = [
        processed_dir / "poses_caucafall.jsonl",
        processed_dir / "poses_up_fall.jsonl",
        processed_dir / "poses_ur_fall.jsonl",
    ]
    ...
    if train_interval_labels is not None:
        command.extend(["--train-interval-labels", str(train_interval_labels)])
